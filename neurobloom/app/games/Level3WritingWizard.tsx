          ...
          >
            ...
            <div className="flex flex-col gap-4 justify-center items-center">
              <motion.button
                ...
                disabled={isUploading}
                className="bg-primary border-4 border-black text-white text-3xl font-black px-16 py-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] active:shadow-none uppercase"
              >
                {t('game_w1_btn_submit')}
              </motion.button>
  
              <label htmlFor="file-upload-replace" className="cursor-pointer">
                <span className="text-black/40 text-sm font-black uppercase underline hover:text-black transition-colors">{t('game_w1_try_again')}</span>
              </label>
              <input
